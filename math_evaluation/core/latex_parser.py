...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="latex2sympy_wrapper", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="parse_latex_wrapper", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="parse_expr_wrapper", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="is_sympy_zero", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="get_sympy_type", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="list_to_mat", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="ineq_to_expr", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="uneq_to_set", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="expr_with_only_i", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="sympy_simplify", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="sympy_expand_equal", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="sympy_abs", seconds=TIMEOUT_SECONDS))
...
@timeout(TIMEOUT_SECONDS, 
    exception_message=TIMEOUT_MESSAGE.format(func_name="sympy_evalf", seconds=TIMEOUT_SECONDS))
def sympy_evalf(
    sympy_expr: Expr, 
